...
var file_proto_consignment_consignment_proto_rawDesc = []byte{
	...
	0xa2, 0x01, 0x0a, 0x13, 0x53, 0x68, 0x69, 0x70, 0x70, 0x69, 0x6e, 0x67, 0x43, 0x6f, 0x6e, 0x73,
	0x69, 0x67, 0x6e, 0x6d, 0x65, 0x6e, 0x74, 0x12, 0x46, 0x0a, 0x11, 0x43, 0x72, 0x65, 0x61, 0x74,
...
var file_proto_consignment_consignment_proto_depIdxs = []int32{
	...
	0, // 3: consignment.ShippingConsignment.CreateConsignment:input_type -> consignment.Consignment
	2, // 4: consignment.ShippingConsignment.GetConsignments:input_type -> consignment.GetRequest
	3, // 5: consignment.ShippingConsignment.CreateConsignment:output_type -> consignment.Response
	3, // 6: consignment.ShippingConsignment.GetConsignments:output_type -> consignment.Response
...
// ShippingConsignmentClient is the client API for ShippingConsignment service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://godoc.org/google.golang.org/grpc#ClientConn.NewStream.
type ShippingConsignmentClient interface {
...
type shippingConsignmentClient struct {
	cc grpc.ClientConnInterface
}

func NewShippingConsignmentClient(cc grpc.ClientConnInterface) ShippingConsignmentClient {
	return &shippingConsignmentClient{cc}
}

func (c *shippingConsignmentClient) CreateConsignment(ctx context.Context, in *Consignment, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/consignment.ShippingConsignment/CreateConsignment", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *shippingConsignmentClient) GetConsignments(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/consignment.ShippingConsignment/GetConsignments", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// ShippingConsignmentServer is the server API for ShippingConsignment service.
type ShippingConsignmentServer interface {
	CreateConsignment(context.Context, *Consignment) (*Response, error)
	// Created a new method
	GetConsignments(context.Context, *GetRequest) (*Response, error)
}

// UnimplementedShippingConsignmentServer can be embedded to have forward compatible implementations.
type UnimplementedShippingConsignmentServer struct {
}

func (*UnimplementedShippingConsignmentServer) CreateConsignment(context.Context, *Consignment) (*Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateConsignment not implemented")
}
func (*UnimplementedShippingConsignmentServer) GetConsignments(context.Context, *GetRequest) (*Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetConsignments not implemented")
}

func RegisterShippingConsignmentServer(s *grpc.Server, srv ShippingConsignmentServer) {
	s.RegisterService(&_ShippingConsignment_serviceDesc, srv)
}

func _ShippingConsignment_CreateConsignment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Consignment)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ShippingConsignmentServer).CreateConsignment(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/consignment.ShippingConsignment/CreateConsignment",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ShippingConsignmentServer).CreateConsignment(ctx, req.(*Consignment))
	}
	return interceptor(ctx, in, info, handler)
}

func _ShippingConsignment_GetConsignments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ShippingConsignmentServer).GetConsignments(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/consignment.ShippingConsignment/GetConsignments",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ShippingConsignmentServer).GetConsignments(ctx, req.(*GetRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _ShippingConsignment_serviceDesc = grpc.ServiceDesc{
	ServiceName: "consignment.ShippingConsignment",
	HandlerType: (*ShippingConsignmentServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "CreateConsignment",
			Handler:    _ShippingConsignment_CreateConsignment_Handler,
		},
		{
			MethodName: "GetConsignments",
			Handler:    _ShippingConsignment_GetConsignments_Handler,
		},
	},
